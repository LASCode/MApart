...
export const GLOBAL_CONFIG: GlobalConfig = {
    ...
    YANDEX_RATING_IFRAME_HREF: "https://yandex.ru/sprav/widget/rating-badge/131369261464?type=rating",
    MAP_IFRAME_HREF:
        "https://yandex.ru/map-widget/v1/?um=constructor%3A1539f7e7a294d20b2b6f1f3f06cc98f294b5792bf768dc3def8cbae130f8ad72&amp;source=constructor",
    BLOCK_INFO_CONTENT: `
        <div style="font-weight: bold">Дорогие гости!</div>
        <div>
            Если у вас модуль бронирования работает некорректно, просим уточнять информацию по номеру телефона.
        </div>
    `,
};
