...
export const GREY_ROOM_CONFIG: RoomConfig = {
    ...
    description:
        ...
        "двуспальная кровать с белоснежными, чистыми простынями, раскладывающийся мягкий, удобный диван, комфортная ванная " +
        "комната, чистые, хрустящие полотенца, фен, личный санузел, ТВ и высокоскоростной интернет, кондиционер.",
